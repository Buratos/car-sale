...
{{--@if (session('error'))
	<script type="text/javascript">
    console.log("LARAVEL ERROR: {{session('error')}}");
	</script>
	<div class="content container-fluid container-md pt-0 pb-0">
		<div class="row">
			<div class="col">
				<div class="alert alert-dark error_message">
					...
					<span>{{__("Something went wrong. We don't know what yet. Failed to create your ad. You can try again")}}</span>
				</div>
			</div>
		</div>
	</div>
