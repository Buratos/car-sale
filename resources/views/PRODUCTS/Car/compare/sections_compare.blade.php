...
@section("tag_head")
	<head>
		...
		<script src="{{asset('/plugins/products-comparison-table/js/compare.js')}}"></script>
		<link rel="stylesheet" href="{{asset('/plugins/products-comparison-table/css/compare.css')}}">
