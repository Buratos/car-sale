@extends("PRODUCTS.Laptop.index.layout")
...
@section("tag_head")
	<head>
		...
		<link href="{{asset('/admin/plugins/ion-rangeslider/css/ion.rangeSlider__my_mod.css')}}" rel="stylesheet">
		...
		<link href="{{asset('/css/btn_checkbox.css')}}" rel="stylesheet"/>
...
@section("filters")
	{{-- FILTERS --}}
	@include("PRODUCTS.Laptop.common_sections.filters")
@endsection

@section("content")
	{{-- CONTENT --}}
	<content>
		@include("PRODUCTS.Laptop.index.content")
	</content>
@endsection
