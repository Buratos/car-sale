@extends("category_selection.layout")
...
@section("tag_head")
	<head>
		...
		<script src="{{asset('/js/main__view_car.js.js')}}" type="module"></script>
		<link href="{{asset('/css/my_reset.css')}}" rel="stylesheet"/>
		{{--  --}}
		<link href="{{asset('/css/style.css')}}" rel="stylesheet"/>
		<link href="{{asset('/css/category_selection.css')}}" rel="stylesheet"/>
...
@section("content")
	{{-- CONTENT --}}
	<content>
		@include("category_selection.content")
	</content>
@endsection
